...
use sp_runtime::{traits::IdentifyAccount, Digest, DigestItem, MultiAddress, Perbill, Perquintill};
use sp_std::prelude::*;
...
cfg_if! {
    if #[cfg(feature = "use-vara-runtime")] {
        pub use vara_runtime::{
            ...
            governance::{
                CooloffPeriod, DesiredMembers, EnactmentPeriod, FastTrackVotingPeriod, LaunchPeriod,
                VotingPeriod,
            },
            AuthorityDiscoveryConfig, Authorship, Babe, BabeConfig, Balances, CouncilConfig, Democracy,
            DemocracyConfig, ElectionsConfig, EpochDuration, Grandpa, GrandpaConfig, ImOnlineConfig,
            NominationPoolsConfig, Preimage, Runtime, RuntimeCall, RuntimeOrigin, Scheduler, Session,
            SessionConfig, SessionKeys, StakerStatus, Staking, StakingConfig, StakingRewards,
            StakingRewardsConfig, SudoConfig, System, TechnicalCommitteeConfig, Timestamp,
            TransactionPayment, TransactionPaymentConfig, Treasury, TreasuryConfig, UncheckedExtrinsic,
            BABE_GENESIS_EPOCH_CONFIG, EXISTENTIAL_DEPOSIT, MILLISECONDS_PER_YEAR, MILLISECS_PER_BLOCK,
        };
    } else {
        pub use crate::runtime::{
            ...
            StakingRewardsConfig, SudoConfig, System, TechnicalCommitteeConfig, Timestamp,
            TransactionPayment, TransactionPaymentConfig, Treasury, TreasuryConfig, UncheckedExtrinsic,
            VotingPeriod, BABE_GENESIS_EPOCH_CONFIG, EXISTENTIAL_DEPOSIT, MILLISECONDS_PER_YEAR,
            MILLISECS_PER_BLOCK,
        };
    }
}
    ...
    pub fn build(self) -> sp_io::TestExternalities {
        ...
        ext.execute_with(|| {
            ...
            if total_supply < self.total_supply {
                // Mint the difference to Treasury
