...
impl<T: frame_system::Config> WeightInfo for BenchmarkWeight<T> {
	...
	fn claim_value() -> Weight {
        ...
        WEIGHTS_JSON["claim_value"].calc_weight::<T>(components)
	}
	fn upload_code(c: u32, ) -> Weight {
        ...
        WEIGHTS_JSON["upload_code"].calc_weight::<T>(components)
	}
	fn create_program(s: u32, ) -> Weight {
        ...
        WEIGHTS_JSON["create_program"].calc_weight::<T>(components)
	}
	fn upload_program(c: u32, s: u32, ) -> Weight {
        ...
        WEIGHTS_JSON["upload_program"].calc_weight::<T>(components)
	}
