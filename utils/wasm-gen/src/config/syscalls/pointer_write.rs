...
#[derive(Debug, Clone)]
pub struct PointerWritesConfig(HashMap<PtrType, Vec<PointerWriteGenerator>>);

impl Default for PointerWritesConfig {
    fn default() -> PointerWritesConfig {
        let value_write_data = PointerWriteDataGenerator::U128(0..=100_000_000_000);
...
impl PointerWritesConfig {
    ...
    pub fn set_rule(&mut self, ptr_type: PtrType, pointer_writes: Vec<PointerWriteGenerator>) {
    ...
    pub fn get_rule(&self, ptr_type: PtrType) -> Option<Vec<PointerWriteGenerator>> {
...
#[derive(Debug, Clone)]
pub struct PointerWriteGenerator {
    /// Relative to the pointer address that's set in syscall invoke
    /// instructions.
    pub offset: usize,
    pub data: PointerWriteDataGenerator,
}
...
#[derive(Debug, Clone)]
pub enum PointerWriteDataGenerator {
