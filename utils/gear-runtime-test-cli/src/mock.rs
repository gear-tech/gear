...
pub(crate) const USER_1: AccountId = 1000001;
pub(crate) const USER_2: AccountId = 1000002;
pub(crate) const USER_3: AccountId = 1000003;
pub(crate) const LOW_BALANCE_USER: AccountId = 1000004;
...
impl pallet_gear::Config for Test {
    ...
    type DebugInfo = pallet_gear_debug::Pallet<Test>;
}
...
pub fn new_test_ext() -> sp_io::TestExternalities {
    ...
    pallet_balances::GenesisConfig::<Test> {
        balances: vec![
            (
                USER_1,
                (<Test as pallet_gear::Config>::BlockGasLimit::get() * 10) as u128,
            ),
