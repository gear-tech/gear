...
/// Config is basically a set of [`RepeatedGenerator`]s, telling how much
/// extrinsics of the particular type should be generated by the [`GearCalls`].
...
/// Trait that describes generator that can generate parameters to call extrinsics.
