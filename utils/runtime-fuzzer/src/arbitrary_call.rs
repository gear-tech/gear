...
use gear_wasm_gen::{
    EntryPointsSet, StandardGearWasmConfigsBundle, SysCallName, SysCallsInjectionAmounts, ParamType, SysCallsParamsConfig,
};
use sha1::*;
use std::{
    fmt::Debug,
...
fn config(
    ...
    injection_amounts.set(SysCallName::Free, 20, 30);
