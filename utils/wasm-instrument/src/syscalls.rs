...
impl SysCallName {
    ...
    pub fn signature(self) -> SysCallSignature {
        ...
        match self {
            ...
            Self::Bls381MultiMillerLoop => SysCallSignature::system([Size, Ptr(None), Size, Ptr(None), Ptr(None), Ptr(None)], [I32]),
            Self::Bls381FinalExponentiation => SysCallSignature::system([Size, Ptr(None), Ptr(None), Ptr(None)], [I32]),
