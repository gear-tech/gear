...
impl SysCallName {
    pub fn to_str(&self) -> &'static str {
        match self {
            ...
            SysCallName::ReservationReplyWGas => "gr_reservation_reply_wgas",
            SysCallName::ReservationReplyCommit => "gr_reservation_reply_commit",
            SysCallName::ReservationReplyCommitWGas => "gr_reservation_reply_commit_wgas",
            SysCallName::ReservationSend => "gr_reservation_send",
            SysCallName::ReservationSendWGas => "gr_reservation_send_wgas",
            SysCallName::ReservationSendCommit => "gr_reservation_send_commit",
            SysCallName::ReservationSendCommitWGas => "gr_reservation_send_commit_wgas",
    ...
    pub fn signature(self) -> SysCallSignature {
        ...
        match self {
            ...
            Self::ReservationReplyWGas => SysCallSignature::gr([Ptr, Ptr, Size, Ptr, Gas]),
            Self::ReservationReplyCommit => SysCallSignature::gr([Ptr, Ptr]),
            Self::ReservationReplyCommitWGas => SysCallSignature::gr([Ptr, Ptr, Gas]),
            ...
            Self::ReservationSendWGas => SysCallSignature::gr([Ptr, Ptr, Size, Gas, Delay, Ptr]),
            Self::ReservationSendCommit => SysCallSignature::gr([Handler, Ptr, Delay, Ptr]),
            Self::ReservationSendCommitWGas => {
                SysCallSignature::gr([Handler, Ptr, Gas, Delay, Ptr])
            }
