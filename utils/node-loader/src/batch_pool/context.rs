use crate::{args::SeedVariant, generators, utils};
...
pub(super) struct TasksContext {
    pub code_seed_gen: Box<dyn utils::LoaderRngCore>,
    // TODO DN
...
impl TasksContext {
    pub(super) fn new<Rng: crate::LoaderRng>(code_seed_type: Option<SeedVariant>) -> Self {
        Self {
