...
fn debug_mode_works() {
    ...
    new_test_ext().execute_with(|| {
        ...
        let program_id_1 = ProgramId::generate(0u32, CodeId::generate(&code_1), DEFAULT_SALT);
        let program_id_2 = ProgramId::generate(0u32, CodeId::generate(&code_2), DEFAULT_SALT);
...
fn check_not_allocated_pages() {
    ...
    new_test_ext().execute_with(|| {
        ...
        let program_id = ProgramId::generate(0u32, CodeId::generate(&code), DEFAULT_SALT);
