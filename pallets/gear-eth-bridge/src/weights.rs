...
// Executed Command:
// ./target/release/gear benchmark pallet --chain=vara-dev --steps=50 --repeat=20 --pallet=pallet_gear_eth_bridge --extrinsic=* --heap-pages=4096 --output=/home/romanm/work/gear/pallets/gear-eth-bridge/src/weights.rs --template=.maintain/frame-weight-template.hbs
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    fn pause() -> Weight {
        ...
        Weight::from_parts(8_906_000, 1486)
    ...
    fn unpause() -> Weight {
        ...
        Weight::from_parts(8_035_000, 1486)
            .saturating_add(T::DbWeight::get().reads(2_u64))
            .saturating_add(T::DbWeight::get().writes(1_u64))
    }
    fn send_eth_message() -> Weight {
