use crate::{Config, EthMessage, WeightInfo, builtin, mock::*};
...
fn bridge_got_initialized() {
    ...
    new_test_ext().execute_with(|| {
        ...
        do_events_assertion(6, 37, [GrandpaEvent::NewAuthorities {
