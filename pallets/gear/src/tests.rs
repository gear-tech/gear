...
fn delayed_send_program_message_payment() {
    ...
    fn scenario(delay: BlockNumber) {
        ...
        let (_init_mid, proxy) =
            init_constructor(demo_proxy_with_gas::scheme(program_address.into(), delay.saturated_into()));
    ...
    new_test_ext().execute_with(|| {
        ...
        assert_ok!(Gear::upload_program(
            ...
            InitAction::Normal(vec![
                (50_000, expiration_block.saturated_into()),
                (25_000, expiration_block.saturated_into()),
            ])
            .encode(),
            50_000_000_000,
            0,
    ...
    new_test_ext().execute_with(|| {
        ...
        assert_ok!(Gear::send_message(
            ...
            vec![
                ...
                Kind::PayProgramRent(
                    pay_rent_id.into_origin().into(),
                    Gear::rent_fee_for(u32::MAX as u64),
                    None
                )
            ]
            .encode(),
...
fn pay_program_rent_extrinsic_works() {
    ...
    new_test_ext().execute_with(|| {
        ...
        let _ = Balances::force_set_balance(RuntimeOrigin::root(), USER_1, u128::MAX);
