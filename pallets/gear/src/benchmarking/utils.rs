    ...
    T::AccountId: Origin,
{
    ...
    let dispatch = match kind {
        HandleKind::Init(ref code) => {
            let program_id =
                ProgramId::generate_with_nonce(CodeId::generate(code), b"bench_salt", root_message_id);
        ...
        HandleKind::InitByHash(code_id) => {
            let program_id = ProgramId::generate_with_nonce(code_id, b"bench_salt", root_message_id);
