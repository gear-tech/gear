...
use crate::{
    self as pallet_gear_builtin_actor, BuiltinActor, BuiltinActorError, RegisteredBuiltinActor,
...
impl BuiltinActor<SimpleBuiltinMessage, u64> for FirstBuiltinActor {
    fn handle(
...
impl RegisteredBuiltinActor<SimpleBuiltinMessage, u64> for FirstBuiltinActor {
    const ID: BuiltinId = BuiltinId(1_u64);
}

pub struct SecondBuiltinActor {}
impl BuiltinActor<SimpleBuiltinMessage, u64> for SecondBuiltinActor {
    fn handle(
        _message: &SimpleBuiltinMessage,
        _gas_limit: u64,
    ) -> (Result<Vec<u8>, BuiltinActorError>, u64) {
...
impl RegisteredBuiltinActor<SimpleBuiltinMessage, u64> for SecondBuiltinActor {
    const ID: BuiltinId = BuiltinId(2_u64);
}

pub struct ThirdBuiltinActor {}
impl BuiltinActor<SimpleBuiltinMessage, u64> for ThirdBuiltinActor {
    fn handle(
        _message: &SimpleBuiltinMessage,
        _gas_limit: u64,
    ) -> (Result<Vec<u8>, BuiltinActorError>, u64) {
...
impl RegisteredBuiltinActor<SimpleBuiltinMessage, u64> for ThirdBuiltinActor {
    const ID: BuiltinId = BuiltinId(3_u64);
}

// Duplicate builtin id: `BuiltinId(2)` already exists.
pub struct DuplicateBuiltinActor {}
impl BuiltinActor<SimpleBuiltinMessage, u64> for DuplicateBuiltinActor {
    fn handle(
        _message: &SimpleBuiltinMessage,
        _gas_limit: u64,
    ) -> (Result<Vec<u8>, BuiltinActorError>, u64) {
...
impl RegisteredBuiltinActor<SimpleBuiltinMessage, u64> for DuplicateBuiltinActor {
    const ID: BuiltinId = BuiltinId(2_u64);
}
