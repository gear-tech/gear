...
//! Autogenerated weights for `pallet_gear_built_in_actor`
//!
...
/// Weight functions for `pallet_gear_built_in_actor`.
pub trait WeightInfo {
    fn base_handle_weight() -> Weight;
}

/// Weights for `pallet_gear_built_in_actor` using a Gear node and recommended hardware.
