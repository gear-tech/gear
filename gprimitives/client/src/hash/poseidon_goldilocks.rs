...
//! Necessary functions implementations for Poseidon over Goldilocks field of widths 8 and 12.
//! Derived from the implementation in the [`plonky2`](https://crates.io/crates/plonky2) crate
//! that follows the original paper <https://eprint.iacr.org/2019/458.pdf>.

//! The constants used in this implementation *must* be generated using the
...
use crate::{
    ...
    hash::poseidon::{Poseidon, N_PARTIAL_ROUNDS},
};
...
mod tests {
    ...
    use crate::{
        ...
        hash::poseidon::test_helpers::{check_consistency, check_test_vectors},
    };
