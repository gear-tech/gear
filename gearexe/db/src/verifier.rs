...
use gearexe_common::{BlockHeader, BlockMeta, ScheduledTask};
use gearexe_runtime_common::state::{HashOf, MessageQueue, MessageQueueHashWithSize};
...
mod tests {
    ...
    use gearexe_runtime_common::state::{MaybeHashOf, Storage};
    use gear_core::{
    ...
    fn test_invalid_code_len_in_metadata_error() {
        ...
        db.set_instrumented_code(
            gearexe_runtime_common::VERSION,
            code_id,
