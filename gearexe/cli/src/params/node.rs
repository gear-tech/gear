...
use gearexe_common::gear::MAX_BLOCK_GAS_LIMIT;
use gearexe_processor::{DEFAULT_BLOCK_GAS_LIMIT, DEFAULT_CHUNK_PROCESSING_THREADS};
use gearexe_service::config::{ConfigPublicKey, NodeConfig};
...
impl NodeParams {
    ...
    fn default_base() -> PathBuf {
        ProjectDirs::from("com", "Gear", "gearexe")
