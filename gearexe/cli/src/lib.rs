...
#[derive(Debug, Parser)]
pub struct Cli {
    /// Path to the TOML config file. If not provided, the default path "./.gearexe.toml" is used. To disable parsing of the config file, use "none".
    #[arg(long)]
...
impl Cli {
    ...
    pub const DEFAULT_PARAMS_PATH: &str = "./.gearexe.toml";
