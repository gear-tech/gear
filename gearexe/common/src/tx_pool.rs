...
impl SignedOffchainTransaction {
    /// Gearexe transaction blake2b256 hash.
    pub fn tx_hash(&self) -> H256 {
        gear_core::utils::hash(&self.encode()).into()
    }

    /// Gearexe transaction reference block hash
    ///
...
/// Gearexe offchain transaction with a reference block for mortality.
...
impl OffchainTransaction {
    ...
    ///
    /// ### Rationale
    /// The constant could have been defined in the `gearexe-db`,
...
/// Raw gearexe offchain transaction.
///
