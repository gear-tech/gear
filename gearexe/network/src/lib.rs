...
use gearexe_common::ecdsa::PublicKey;
...
pub const PROTOCOL_VERSION: &str = "gearexe/0.1.0";
...
fn commitments_topic() -> gossipsub::IdentTopic {
    ...
    gossipsub::IdentTopic::new("gearexe-commitments")
}

fn offchain_tx_topic() -> gossipsub::IdentTopic {
    gossipsub::IdentTopic::new("gearexe-tx-pool")
}
...
mod tests {
    ...
    use gearexe_signer::{FSKeyStorage, Signer};
