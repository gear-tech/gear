...
mod tests {
    ...
    fn test_propagate_data_from_parent_batch_committed() {
        ...
        let events = [BlockEvent::Router(
            gearexe_common::events::RouterEvent::BatchCommitted { digest: new_digest },
        )];
    ...
    fn test_propagate_data_from_parent_code_validation_requested_existing() {
        ...
        let events = [BlockEvent::Router(
            gearexe_common::events::RouterEvent::CodeValidationRequested {
                code_id,
                timestamp: 1000,
    ...
    fn test_propagate_data_from_parent_code_got_validated_missing() {
        ...
        let events = [BlockEvent::Router(
            gearexe_common::events::RouterEvent::CodeGotValidated {
                code_id,
                valid: true,
            },
        )];
    ...
    fn test_propagate_data_from_parent_other_events() {
        ...
        let events = vec![
            BlockEvent::Router(
                gearexe_common::events::RouterEvent::ComputationSettingsChanged {
                    threshold: 100,
                    wvara_per_second: 200,
                },
            ),
            BlockEvent::Router(gearexe_common::events::RouterEvent::ProgramCreated {
    ...
    fn test_propagate_data_from_parent_combined_events() {
        ...
        let new_digest = Digest([99; 32]);
        let events = vec![
            BlockEvent::Router(gearexe_common::events::RouterEvent::BatchCommitted {
                digest: new_digest,
            }),
            BlockEvent::Router(
                gearexe_common::events::RouterEvent::CodeValidationRequested {
            ...
            BlockEvent::Router(gearexe_common::events::RouterEvent::CodeGotValidated {
                code_id: code_id3,
                valid: true,
            }),
        ];
