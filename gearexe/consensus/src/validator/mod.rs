...
//!
//! This module provides the core validation functionality for the Gearexe system.
...
use gearexe_common::{Address, SimpleBlockData, ecdsa::PublicKey};
use gearexe_db::Database;
use gearexe_ethereum::Ethereum;
...
pub struct ValidatorConfig {
    ...
    /// Duration of gearexe slot (only to identify producer for the incoming blocks)
