...
use gear_runtime::{
    ...
    SessionConfig, SystemConfig, ValidatorSetConfig, BABE_GENESIS_EPOCH_CONFIG, WASM_BINARY,
};
use sp_keyring::{Ed25519Keyring, Sr25519Keyring};
// #[cfg(feature = "vara-native")]
// use vara_runtime::{
//     constants::currency::*, AccountId, BabeConfig, BalancesConfig, GenesisConfig, GrandpaConfig,
//     SessionConfig, StakerStatus, StakingConfig, StakingRewardsConfig, SystemConfig,
...
pub fn config_endowed(code: Option<&[u8]>, extra_endowed: Vec<AccountId>) -> GenesisConfig {
    ...
    GenesisConfig {
        ...
        validator_set: ValidatorSetConfig {
            initial_validators: vec![alice(), bob(), charlie()],
        },
        session: SessionConfig {
            keys: vec![
                (
