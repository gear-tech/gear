...
impl<F: Extendable<2>> Frobenius<2> for QuadraticExtension<F> where Self: Mul<Output = Self> {}
...
#[cfg(test)]
mod tests {
    use super::{Extendable, QuadraticExtension};
    use crate::field::field_testing::Sample;

    impl<F: Extendable<2> + Sample> Sample for QuadraticExtension<F> {
        #[inline]
    ...
    mod goldilocks {
        ...
        test_field_arithmetic!(
            crate::field::extension::quadratic::QuadraticExtension<
