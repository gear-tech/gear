...
//! #     Externalities, MalachiteConfig, MalachiteCtx, MalachiteService, NetworkMsg, NetworkRef,
//! # };
//! # use std::sync::Arc;
//! # use tokio::sync::mpsc;
...
//!     MalachiteService::<EXT>::new(config, network_ref, tx_network, ext)
//!         .await
...
//! - [`MalachiteService`] — Running service; owns the engine, app task, WAL, and store. Network I/O is supplied by a custom network adapter.
