...
use ethexe_runtime_common::{RUNTIME_ID, ScheduleRestorer, VERSION, state::Storage};
...
async fn genesis_data_initialization(
    ...
    for (code_id, code) in code_bytes {
        ...
        code_processing_futures.push(async move {
            ...
            db_clone.set_instrumented_code(RUNTIME_ID, VERSION, code_id, instrumented_code);
