...
pub trait BitswapAnnouncesHandle {
...
impl AnnouncesRequest {
    pub async fn request(self, bitswap: impl BitswapAnnouncesHandle) -> AnnouncesResponse {
        let mut announces = VecDeque::new();
        let mut announce_hash = self.head;
        ...
        loop {
            ...
            let announce = bitswap.request(announce_hash).await;
