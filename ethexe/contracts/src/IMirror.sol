...
interface IMirror {
    ...
    function implAddress() external view returns (address);
    ...
    function initialize(address initializer, address router, address implAddress, address _interface) external;
