...
//! Chunk splitting logic for program execution.
//!
//! This module implements the algorithm for splitting programs into chunks
//! based on their queue sizes for parallel execution.
