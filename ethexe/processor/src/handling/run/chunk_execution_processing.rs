...
//! Chunk execution processing logic.
//!
//! This module handles collecting and processing journals from executed programs.
...
pub fn process_chunk_execution_journals(
    ...
    for (program_id, program_journals) in chunk_journals {
        for (journal, message_type, call_reply) in program_journals {
            ...
            gear_processor::handle_journal(journal, &mut journal_handler);
