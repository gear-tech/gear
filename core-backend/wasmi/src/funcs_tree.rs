    ...
    E::AllocError: BackendAllocExtError<ExtError = E::Error>,
{
    ...
    let funcs: BTreeMap<_, _> = [
        ...
        // TODO (breathx): change it
        f.build(StatusCode, |forbidden| wrap_common_func!(CommonFuncsHandler::exit, (1) -> ())(store, forbidden, memory)),
        ...
        f.build(ReplyInput, |forbidden| wrap_common_func!(CommonFuncsHandler::reply_input, (5) -> ())(store, forbidden, memory)),
        f.build(ReplyPushInput, |forbidden| wrap_common_func!(CommonFuncsHandler::reply_push_input, (3) -> ())(store, forbidden, memory)),
        f.build(ReplyInputWGas, |forbidden| wrap_common_func!(CommonFuncsHandler::reply_input_wgas, (6) -> ())(store, forbidden, memory)),
