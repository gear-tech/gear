...
//!    [`JournalHandler::send_dispatch`](gear_core_processor::common::JournalHandler::send_dispatch) and
//!    [`JournalHandler::send_value`](gear_core_processor::common::JournalHandler::send_value) procedures.
//!
...
//!
//! [`JournalHandler::send_dispatch`](gear_core_processor::common::JournalHandler::send_dispatch) for program's messages won't fail, because there is always a
