    ...
    T::AccountId: Origin,
{
    ...
    let context = context
        ...
        .map_err(|_| "gear_processor::precharge_for_program failed")?;
    ...
    let context = context
        ...
        .map_err(|_| "gear_processor::precharge_for_code_metadata failed")?;
    ...
    let context = context
        ...
        .map_err(|_| "gear_processor::precharge_for_instrumented_code failed")?;
    ...
    let context = context
        ...
        .map_err(|_| "gear_processor::precharge_for_allocations failed")?;
    ...
    let context = context
        ...
        .map_err(|_| "gear_processor::precharge_for_module_instantiation failed")?;
