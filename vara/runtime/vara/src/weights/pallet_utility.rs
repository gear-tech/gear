...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(553_469, 0)
            // Standard Error: 5_831
            .saturating_add(Weight::from_parts(1_826_003, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(24_143_463, 0)
            // Standard Error: 10_564
            .saturating_add(Weight::from_parts(1_942_829, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(2_863_000, 0)
            ...
            .saturating_add(Weight::from_parts(1_818_957, 0).saturating_mul(c.into()))
    }
}
