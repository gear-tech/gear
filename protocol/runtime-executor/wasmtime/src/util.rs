...
use crate::{InstantiationStrategy, memory_wrapper::MemoryWrapper, store_data::StoreData};
...
pub fn allocate_memory(
    ...
    let result = allocator
        ...
        .map_err(|error: sp_allocator::Error| Error::Other(error.to_string()));
