...
impl MetaData {
    ...
    pub fn convert(self, meta_wasm: &str, _meta_type: &MetaType) -> Result<Self, String> {
        let gear_path = {
        ...
        match self {
            Self::CodecBytes(_) => Ok(Self::Json(Default::default())),
            Self::Json(_) => Ok(Self::CodecBytes(Default::default())),
        }
    }
}
