...
use gear_core::pages::NonEmptyInterval;
use std::fmt::Debug;
...
pub(crate) fn mprotect_pages<M: SizeManager, S: SizeNumber, I: Into<NonEmptyInterval<Page<S>>>>(
    mem_addr: usize,
    ...
    for interval in pages {
        let interval: NonEmptyInterval<Page<S>> = interval.into();
