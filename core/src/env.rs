...
use crate::{
    ...
    memory::Memory,
    message::{HandlePacket, InitPacket, MessageContext, ReplyPacket, SharedPayload},
    pages::WasmPage,
};
...
impl PayloadSlice {
    ...
    pub fn try_new(start: u32, end: u32, payload: SharedPayload) -> Option<Self> {
...
pub trait Externalities {
    ...
    /// Return payload of the message currently being handled.
