...
use crate::{error::Result, ActorId, CodeHash, MessageId};
...
///             .into();
///     let (new_program_id, init_message_id) =
...
///     msg::load(&mut salt[..]);
///     let (new_program_id, init_message_id) = prog::create_program_with_gas(submitted_code, &salt, b"", 10_000, 0).unwrap();
/// }
/// ```
///
