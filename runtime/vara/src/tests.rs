...
fn syscall_weights_test() {
    ...
    let expected = SyscallWeights {
        ...
        free_range_per_page: 45_000.into(),
        gr_reserve_gas: 2_600_000.into(),
        gr_unreserve_gas: 2_600_000.into(),
        gr_system_reserve_gas: 1_200_000.into(),
        gr_gas_available: 1_100_000.into(),
        gr_message_id: 1_100_000.into(),
        gr_program_id: 1_100_000.into(),
        gr_source: 1_100_000.into(),
        gr_value: 1_100_000.into(),
        gr_value_available: 1_200_000.into(),
        gr_size: 1_100_000.into(),
        gr_read: 2_100_000.into(),
        gr_read_per_byte: 200.into(),
        gr_env_vars: 1_400_000.into(),
        gr_block_height: 1_200_000.into(),
        gr_block_timestamp: 1_100_000.into(),
