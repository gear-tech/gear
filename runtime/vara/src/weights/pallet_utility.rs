...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(6_319_911, 0)
            // Standard Error: 1_610
            .saturating_add(Weight::from_parts(4_061_906, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(8_198_061, 0)
            // Standard Error: 2_896
            .saturating_add(Weight::from_parts(4_277_001, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(3_330_380, 0)
            // Standard Error: 2_561
            .saturating_add(Weight::from_parts(4_075_461, 0).saturating_mul(c.into()))
    }
}
