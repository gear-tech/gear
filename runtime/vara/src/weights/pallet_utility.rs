...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(1_448_683, 0)
            // Standard Error: 4_681
            .saturating_add(Weight::from_parts(3_977_079, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(2_863_906, 0)
            // Standard Error: 3_986
            .saturating_add(Weight::from_parts(4_203_231, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(7_657_508, 0)
            // Standard Error: 3_591
            .saturating_add(Weight::from_parts(3_950_680, 0).saturating_mul(c.into()))
    }
}
