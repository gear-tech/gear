...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(8_226_968, 0)
            // Standard Error: 1_440
            .saturating_add(Weight::from_parts(4_013_947, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(5_966_765, 0)
            // Standard Error: 3_899
            .saturating_add(Weight::from_parts(4_213_246, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(9_512_279, 0)
            // Standard Error: 4_130
            .saturating_add(Weight::from_parts(4_035_478, 0).saturating_mul(c.into()))
    }
}
