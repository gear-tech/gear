...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(15_138_158, 0)
            // Standard Error: 2_071
            .saturating_add(Weight::from_parts(3_958_890, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(12_724_758, 0)
            // Standard Error: 1_830
            .saturating_add(Weight::from_parts(4_146_725, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(12_700_602, 0)
            // Standard Error: 2_607
            .saturating_add(Weight::from_parts(3_964_305, 0).saturating_mul(c.into()))
    }
}
