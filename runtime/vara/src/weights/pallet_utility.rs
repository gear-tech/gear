...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(10_862_515, 0)
            // Standard Error: 1_994
            .saturating_add(Weight::from_parts(4_085_707, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(12_414_946, 0)
            // Standard Error: 1_927
            .saturating_add(Weight::from_parts(4_247_446, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(10_157_458, 0)
            // Standard Error: 2_111
            .saturating_add(Weight::from_parts(4_082_356, 0).saturating_mul(c.into()))
    }
}
