...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(6_829_209, 0)
            // Standard Error: 2_568
            .saturating_add(Weight::from_parts(3_879_722, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(10_609_687, 0)
            // Standard Error: 2_687
            .saturating_add(Weight::from_parts(4_082_713, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(3_102_490, 0)
            // Standard Error: 4_178
            .saturating_add(Weight::from_parts(3_912_133, 0).saturating_mul(c.into()))
    }
}
