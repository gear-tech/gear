...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        Weight::from_ref_time(18_167_000 as u64)
            // Standard Error: 866
            .saturating_add(Weight::from_ref_time(5_865_645 as u64).saturating_mul(c as u64))
    }
    fn as_derivative() -> Weight {
    ...
    /// The range of component `c` is `[0, 1000]`.
    fn batch_all(c: u32, ) -> Weight {
        Weight::from_ref_time(18_037_000 as u64)
            // Standard Error: 774
            .saturating_add(Weight::from_ref_time(6_048_956 as u64).saturating_mul(c as u64))
    }
    fn dispatch_as() -> Weight {
        Weight::from_ref_time(20_752_000 as u64)
    }
    /// The range of component `c` is `[0, 1000]`.
    fn force_batch(c: u32, ) -> Weight {
        Weight::from_ref_time(18_226_000 as u64)
            // Standard Error: 907
            .saturating_add(Weight::from_ref_time(5_891_410 as u64).saturating_mul(c as u64))
    }
}
