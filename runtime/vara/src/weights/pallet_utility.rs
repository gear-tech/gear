...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(19_376_528, 0)
            // Standard Error: 3_668
            .saturating_add(Weight::from_parts(3_842_061, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(14_907_859, 0)
            // Standard Error: 3_351
            .saturating_add(Weight::from_parts(4_068_633, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(17_652_073, 0)
            // Standard Error: 2_928
            .saturating_add(Weight::from_parts(3_847_675, 0).saturating_mul(c.into()))
    }
}
