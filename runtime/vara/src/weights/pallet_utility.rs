...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(9_624_896, 0)
            // Standard Error: 916
            .saturating_add(Weight::from_parts(3_061_828, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(8_298_190, 0)
            // Standard Error: 1_144
            .saturating_add(Weight::from_parts(3_288_379, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(8_985_838, 0)
            // Standard Error: 2_059
            .saturating_add(Weight::from_parts(3_062_962, 0).saturating_mul(c.into()))
    }
}
