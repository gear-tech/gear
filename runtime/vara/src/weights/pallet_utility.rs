...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(17_754_258, 0)
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(10_817_895, 0)
            // Standard Error: 2_982
            .saturating_add(Weight::from_parts(4_277_509, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(5_099_636, 0)
            // Standard Error: 4_919
            .saturating_add(Weight::from_parts(4_115_364, 0).saturating_mul(c.into()))
    }
}
