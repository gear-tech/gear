...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(5_932_392, 0)
            // Standard Error: 2_687
            .saturating_add(Weight::from_parts(3_991_008, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(6_781_800, 0)
            // Standard Error: 2_865
            .saturating_add(Weight::from_parts(4_123_526, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(9_628_502, 0)
            // Standard Error: 2_600
            .saturating_add(Weight::from_parts(3_981_855, 0).saturating_mul(c.into()))
    }
}
