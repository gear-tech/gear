...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(3_004_805, 0)
            // Standard Error: 1_738
            .saturating_add(Weight::from_parts(3_088_988, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(2_467_406, 0)
            // Standard Error: 1_444
            .saturating_add(Weight::from_parts(3_084_834, 0).saturating_mul(c.into()))
    }
}
