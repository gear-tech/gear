...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(9_446_348, 0)
            // Standard Error: 2_691
            .saturating_add(Weight::from_parts(3_992_204, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(3_068_634, 0)
            // Standard Error: 3_267
            .saturating_add(Weight::from_parts(4_314_107, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(13_820_969, 0)
            // Standard Error: 2_617
            .saturating_add(Weight::from_parts(4_021_285, 0).saturating_mul(c.into()))
    }
}
