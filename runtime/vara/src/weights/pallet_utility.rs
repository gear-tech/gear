...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(8_163_155, 0)
            // Standard Error: 2_074
            .saturating_add(Weight::from_parts(4_084_858, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(9_180_867, 0)
            // Standard Error: 2_030
            .saturating_add(Weight::from_parts(4_259_130, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(8_377_232, 0)
            // Standard Error: 2_856
            .saturating_add(Weight::from_parts(4_077_791, 0).saturating_mul(c.into()))
    }
}
