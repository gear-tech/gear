...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(10_160_308, 0)
            // Standard Error: 2_965
            .saturating_add(Weight::from_parts(2_314_025, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(8_716_648, 0)
            // Standard Error: 2_246
            .saturating_add(Weight::from_parts(2_500_028, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(168_281, 0)
            // Standard Error: 2_646
            .saturating_add(Weight::from_parts(2_390_861, 0).saturating_mul(c.into()))
    }
}
