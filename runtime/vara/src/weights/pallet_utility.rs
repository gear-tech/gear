...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        Weight::from_ref_time(23_417_000 as u64)
            // Standard Error: 1_598
            .saturating_add(Weight::from_ref_time(5_082_299 as u64).saturating_mul(c as u64))
    }
    fn as_derivative() -> Weight {
    ...
    /// The range of component `c` is `[0, 1000]`.
    fn batch_all(c: u32, ) -> Weight {
        Weight::from_ref_time(14_990_000 as u64)
            // Standard Error: 1_293
            .saturating_add(Weight::from_ref_time(5_178_868 as u64).saturating_mul(c as u64))
    }
    fn dispatch_as() -> Weight {
        Weight::from_ref_time(17_205_000 as u64)
    }
    /// The range of component `c` is `[0, 1000]`.
    fn force_batch(c: u32, ) -> Weight {
        Weight::from_ref_time(14_870_000 as u64)
            // Standard Error: 692
            .saturating_add(Weight::from_ref_time(5_008_046 as u64).saturating_mul(c as u64))
    }
}
