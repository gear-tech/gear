...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(6_415_475, 0)
            // Standard Error: 1_440
            .saturating_add(Weight::from_parts(3_950_720, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(8_452_741, 0)
            // Standard Error: 1_413
            .saturating_add(Weight::from_parts(4_135_364, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(5_361_407, 0)
            // Standard Error: 2_331
            .saturating_add(Weight::from_parts(3_979_379, 0).saturating_mul(c.into()))
    }
}
