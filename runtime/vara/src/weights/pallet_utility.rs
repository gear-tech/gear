...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(8_120_311, 0)
            // Standard Error: 2_004
            .saturating_add(Weight::from_parts(3_792_259, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(10_544_692, 0)
            // Standard Error: 3_460
            .saturating_add(Weight::from_parts(3_978_091, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(9_762_390, 0)
            // Standard Error: 2_048
            .saturating_add(Weight::from_parts(3_789_327, 0).saturating_mul(c.into()))
    }
}
