...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(5_086_000, 0)
            ...
            .saturating_add(Weight::from_parts(3_126_655, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(5_081_000, 0)
            ...
            .saturating_add(Weight::from_parts(3_467_656, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(5_028_000, 0)
            ...
            .saturating_add(Weight::from_parts(3_147_848, 0).saturating_mul(c.into()))
    }
}
