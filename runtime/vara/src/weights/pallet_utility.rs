...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(3_715_747, 0)
            // Standard Error: 12_175
            .saturating_add(Weight::from_parts(3_899_749, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(13_012_229, 0)
            // Standard Error: 11_672
            .saturating_add(Weight::from_parts(4_067_977, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(5_215_000, 0)
            ...
            .saturating_add(Weight::from_parts(3_928_883, 0).saturating_mul(c.into()))
    }
}
