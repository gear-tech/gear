...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_ref_time(13_002_361)
            // Standard Error: 1_565
            .saturating_add(Weight::from_ref_time(4_160_450).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
        ...
        Weight::from_ref_time(5_095_000)
    }
    /// The range of component `c` is `[0, 1000]`.
    fn batch_all(c: u32, ) -> Weight {
        // Proof Size summary in bytes:
        ...
        Weight::from_ref_time(11_804_218)
            // Standard Error: 1_158
            .saturating_add(Weight::from_ref_time(4_275_227).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
        ...
        Weight::from_ref_time(8_610_000)
    }
    /// The range of component `c` is `[0, 1000]`.
    fn force_batch(c: u32, ) -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
        //  Estimated: `0`
        // Minimum execution time: 6_157 nanoseconds.
        Weight::from_ref_time(11_474_814)
            // Standard Error: 1_279
            .saturating_add(Weight::from_ref_time(4_154_642).saturating_mul(c.into()))
    }
}
