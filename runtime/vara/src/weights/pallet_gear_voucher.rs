...
impl<T: frame_system::Config> pallet_gear_voucher::WeightInfo for SubstrateWeight<T> {
    fn issue() -> Weight {
        ...
        //  Measured:  `282`
        //  Estimated: `6196`
        // Minimum execution time: 44_721_000 picoseconds.
        Weight::from_parts(45_362_000, 6196)
    ...
    fn revoke() -> Weight {
        ...
        Weight::from_parts(49_434_000, 6196)
            .saturating_add(T::DbWeight::get().reads(3_u64))
    ...
    fn update() -> Weight {
        ...
        Weight::from_parts(49_872_000, 6196)
            .saturating_add(T::DbWeight::get().reads(3_u64))
    ...
    fn decline() -> Weight {
        ...
        Weight::from_parts(12_981_000, 3765)
