...
// Executed Command:
// ./target/release/gear benchmark pallet --chain=vara-dev --steps=50 --repeat=20 --pallet=pallet_babe --extrinsic=* --execution=wasm --wasm-execution=compiled --heap-pages=4096 --output=./scripts/benchmarking/weights-output/pallet_babe.rs --template=.maintain/frame-weight-template.hbs
...
impl<T: frame_system::Config> pallet_babe::WeightInfo for SubstrateWeight<T> {
    ...
    fn check_equivocation_proof(_x: u32, ) -> Weight {
        Weight::from_ref_time(121_048_595 as u64)
    }
}
