...
// Executed Command:
// ./target/production/gear benchmark pallet --chain=vara-dev --steps=50 --repeat=20 --pallet=pallet_timestamp --extrinsic=* --heap-pages=4096 --output=./scripts/benchmarking/weights-output/pallet_timestamp.rs --template=.maintain/frame-weight-template.hbs
...
impl<T: frame_system::Config> pallet_timestamp::WeightInfo for SubstrateWeight<T> {
    fn set() -> Weight {
        ...
        //  Measured:  `211`
        //  Estimated: `1493`
        // Minimum execution time: 7_736_000 picoseconds.
        Weight::from_parts(7_965_000, 1493)
