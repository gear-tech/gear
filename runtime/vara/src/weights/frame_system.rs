...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_351_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_573_000, 0)
            // Standard Error: 997
            .saturating_add(Weight::from_parts(684_007, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_646_000, 0)
            // Standard Error: 813
            .saturating_add(Weight::from_parts(531_452, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_487_000, 83)
            // Standard Error: 1_821
            .saturating_add(Weight::from_parts(1_126_082, 0).saturating_mul(p.into()))
