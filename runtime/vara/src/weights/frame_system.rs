...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_494_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_620_000, 0)
            // Standard Error: 875
            .saturating_add(Weight::from_parts(687_922, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_731_000, 0)
            // Standard Error: 834
            .saturating_add(Weight::from_parts(525_864, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_517_000, 89)
            // Standard Error: 1_321
            .saturating_add(Weight::from_parts(1_110_092, 0).saturating_mul(p.into()))
