...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_515_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_671_000, 0)
            // Standard Error: 848
            .saturating_add(Weight::from_parts(684_775, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_685_000, 0)
            // Standard Error: 840
            .saturating_add(Weight::from_parts(525_385, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_458_000, 89)
            // Standard Error: 1_478
            .saturating_add(Weight::from_parts(1_115_753, 0).saturating_mul(p.into()))
