...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_393_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_633_000, 0)
            ...
            .saturating_add(Weight::from_parts(679_335, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_702_000, 0)
            // Standard Error: 674
            .saturating_add(Weight::from_parts(530_582, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_351_000, 89)
            // Standard Error: 1_343
            .saturating_add(Weight::from_parts(1_115_950, 0).saturating_mul(p.into()))
