...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_429_000, 1485)
    ...
    fn set_code() -> Weight {
        ...
        //  Measured:  `0`
        //  Estimated: `1485`
        // Minimum execution time: 86_474_814_000 picoseconds.
        Weight::from_parts(92_289_807_000, 1485)
            .saturating_add(T::DbWeight::get().reads(1_u64))
            .saturating_add(T::DbWeight::get().writes(2_u64))
    }
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_623_000, 0)
            ...
            .saturating_add(Weight::from_parts(695_059, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_612_000, 0)
            // Standard Error: 778
            .saturating_add(Weight::from_parts(531_578, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_379_000, 89)
            // Standard Error: 1_589
            .saturating_add(Weight::from_parts(1_138_173, 0).saturating_mul(p.into()))
