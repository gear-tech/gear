...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn remark(b: u32, ) -> Weight {
        ...
        Weight::from_parts(693_740, 0)
            // Standard Error: 0
            .saturating_add(Weight::from_parts(518, 0).saturating_mul(b.into()))
    }
    /// The range of component `b` is `[0, 1310720]`.
    fn remark_with_event(b: u32, ) -> Weight {
        // Proof Size summary in bytes:
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_440_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_644_000, 0)
            ...
            .saturating_add(Weight::from_parts(683_033, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_644_000, 0)
            ...
            .saturating_add(Weight::from_parts(539_438, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_468_000, 89)
            // Standard Error: 2_969
            .saturating_add(Weight::from_parts(1_174_349, 0).saturating_mul(p.into()))
