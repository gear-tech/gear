...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    /// The range of component `b` is `[0, 1310720]`.
    fn remark_with_event(b: u32, ) -> Weight {
        Weight::from_ref_time(15_902_000 as u64)
            // Standard Error: 0
            .saturating_add(Weight::from_ref_time(1_616 as u64).saturating_mul(b as u64))
    }
    fn set_heap_pages() -> Weight {
    ...
    fn set_storage(i: u32, ) -> Weight {
        Weight::from_ref_time(4_759_000 as u64)
            // Standard Error: 866
            .saturating_add(Weight::from_ref_time(855_343 as u64).saturating_mul(i as u64))
            .saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(i as u64)))
    }
    /// The range of component `i` is `[0, 1000]`.
    fn kill_storage(i: u32, ) -> Weight {
        Weight::from_ref_time(4_659_000 as u64)
            // Standard Error: 1_077
            .saturating_add(Weight::from_ref_time(715_795 as u64).saturating_mul(i as u64))
            .saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(i as u64)))
    }
    /// The range of component `p` is `[0, 1000]`.
    fn kill_prefix(p: u32, ) -> Weight {
        Weight::from_ref_time(6_473_000 as u64)
            // Standard Error: 1_293
            .saturating_add(Weight::from_ref_time(1_463_070 as u64).saturating_mul(p as u64))
