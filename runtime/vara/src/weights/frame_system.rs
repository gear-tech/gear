...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_469_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_588_000, 0)
            // Standard Error: 820
            .saturating_add(Weight::from_parts(679_367, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_570_000, 0)
            // Standard Error: 793
            .saturating_add(Weight::from_parts(520_680, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_411_000, 83)
            // Standard Error: 1_126
            .saturating_add(Weight::from_parts(1_103_693, 0).saturating_mul(p.into()))
