...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_259_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_540_000, 0)
            // Standard Error: 895
            .saturating_add(Weight::from_parts(682_678, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_578_000, 0)
            // Standard Error: 801
            .saturating_add(Weight::from_parts(525_393, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_353_000, 83)
            // Standard Error: 1_260
            .saturating_add(Weight::from_parts(1_111_505, 0).saturating_mul(p.into()))
