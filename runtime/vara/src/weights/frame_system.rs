...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_338_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_646_000, 0)
            ...
            .saturating_add(Weight::from_parts(682_094, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_622_000, 0)
            // Standard Error: 836
            .saturating_add(Weight::from_parts(527_553, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_561_000, 83)
            // Standard Error: 1_169
            .saturating_add(Weight::from_parts(1_107_529, 0).saturating_mul(p.into()))
