...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_290_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_632_000, 0)
            // Standard Error: 878
            .saturating_add(Weight::from_parts(704_559, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_624_000, 0)
            // Standard Error: 801
            .saturating_add(Weight::from_parts(524_269, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_552_000, 83)
            // Standard Error: 1_211
            .saturating_add(Weight::from_parts(1_116_901, 0).saturating_mul(p.into()))
