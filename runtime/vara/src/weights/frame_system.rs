...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_588_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_607_000, 0)
            // Standard Error: 928
            .saturating_add(Weight::from_parts(696_070, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_658_000, 0)
            // Standard Error: 866
            .saturating_add(Weight::from_parts(535_984, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_535_000, 89)
            // Standard Error: 1_254
            .saturating_add(Weight::from_parts(1_099_259, 0).saturating_mul(p.into()))
