...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn remark(b: u32, ) -> Weight {
        ...
        Weight::from_parts(828_288, 0)
            // Standard Error: 0
            .saturating_add(Weight::from_parts(428, 0).saturating_mul(b.into()))
    }
    /// The range of component `b` is `[0, 1310720]`.
    fn remark_with_event(b: u32, ) -> Weight {
        // Proof Size summary in bytes:
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_242_000, 1485)
    ...
    fn set_code() -> Weight {
        ...
        //  Measured:  `0`
        //  Estimated: `1485`
        // Minimum execution time: 92_280_665_000 picoseconds.
        Weight::from_parts(103_867_915_000, 1485)
            .saturating_add(T::DbWeight::get().reads(1_u64))
            .saturating_add(T::DbWeight::get().writes(2_u64))
    }
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_638_000, 0)
            ...
            .saturating_add(Weight::from_parts(703_630, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_699_000, 0)
            ...
            .saturating_add(Weight::from_parts(543_728, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_309_000, 89)
            // Standard Error: 2_053
            .saturating_add(Weight::from_parts(1_159_876, 0).saturating_mul(p.into()))
