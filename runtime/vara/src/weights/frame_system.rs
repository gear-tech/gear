...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_459_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_722_000, 0)
            // Standard Error: 834
            .saturating_add(Weight::from_parts(690_785, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_649_000, 0)
            ...
            .saturating_add(Weight::from_parts(531_405, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_391_000, 89)
            // Standard Error: 1_219
            .saturating_add(Weight::from_parts(1_130_965, 0).saturating_mul(p.into()))
