...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_574_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_607_000, 0)
            // Standard Error: 967
            .saturating_add(Weight::from_parts(691_091, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_685_000, 0)
            // Standard Error: 782
            .saturating_add(Weight::from_parts(523_167, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_670_000, 89)
            // Standard Error: 1_344
            .saturating_add(Weight::from_parts(1_121_143, 0).saturating_mul(p.into()))
