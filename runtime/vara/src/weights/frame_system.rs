...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_198_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_574_000, 0)
            // Standard Error: 905
            .saturating_add(Weight::from_parts(671_979, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_606_000, 0)
            // Standard Error: 816
            .saturating_add(Weight::from_parts(525_698, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_368_000, 83)
            // Standard Error: 1_524
            .saturating_add(Weight::from_parts(1_112_490, 0).saturating_mul(p.into()))
