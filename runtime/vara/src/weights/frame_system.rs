...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_438_000, 1485)
    ...
    fn set_code() -> Weight {
        ...
        //  Measured:  `0`
        //  Estimated: `1485`
        // Minimum execution time: 74_574_803_000 picoseconds.
        Weight::from_parts(75_585_056_000, 1485)
            .saturating_add(T::DbWeight::get().reads(1_u64))
            .saturating_add(T::DbWeight::get().writes(2_u64))
    }
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_610_000, 0)
            // Standard Error: 888
            .saturating_add(Weight::from_parts(680_918, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_578_000, 0)
            // Standard Error: 740
            .saturating_add(Weight::from_parts(516_345, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_502_000, 89)
            ...
            .saturating_add(Weight::from_parts(1_095_443, 0).saturating_mul(p.into()))
