...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn remark(b: u32, ) -> Weight {
        ...
        Weight::from_ref_time(735_576)
            // Standard Error: 0
            .saturating_add(Weight::from_ref_time(462).saturating_mul(b.into()))
    }
    /// The range of component `b` is `[0, 1310720]`.
    fn remark_with_event(b: u32, ) -> Weight {
        // Proof Size summary in bytes:
        ...
        Weight::from_ref_time(7_258_000)
            // Standard Error: 0
            .saturating_add(Weight::from_ref_time(1_746).saturating_mul(b.into()))
    }
    fn set_heap_pages() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
        ...
        Weight::from_parts(4_162_000, 495)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_ref_time(1_923_000)
            // Standard Error: 1_059
            .saturating_add(Weight::from_ref_time(761_754).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        //  Measured:  `0`
        //  Estimated: `0`
        // Minimum execution time: 1_861 nanoseconds.
        Weight::from_ref_time(1_947_000)
            // Standard Error: 1_311
            .saturating_add(Weight::from_ref_time(605_724).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_523_000, 80)
            // Standard Error: 2_514
            .saturating_add(Weight::from_ref_time(1_358_307).saturating_mul(p.into()))
