...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_205_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_542_000, 0)
            // Standard Error: 949
            .saturating_add(Weight::from_parts(681_618, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_556_000, 0)
            // Standard Error: 763
            .saturating_add(Weight::from_parts(523_256, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_406_000, 83)
            // Standard Error: 1_367
            .saturating_add(Weight::from_parts(1_119_932, 0).saturating_mul(p.into()))
