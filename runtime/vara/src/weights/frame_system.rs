...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_176_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_602_000, 0)
            ...
            .saturating_add(Weight::from_parts(676_199, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_606_000, 0)
            // Standard Error: 751
            .saturating_add(Weight::from_parts(523_999, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_354_000, 83)
            // Standard Error: 1_375
            .saturating_add(Weight::from_parts(1_112_948, 0).saturating_mul(p.into()))
