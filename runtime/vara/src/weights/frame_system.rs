...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_370_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_609_000, 0)
            // Standard Error: 921
            .saturating_add(Weight::from_parts(720_053, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_637_000, 0)
            // Standard Error: 781
            .saturating_add(Weight::from_parts(547_705, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_491_000, 89)
            ...
            .saturating_add(Weight::from_parts(1_144_029, 0).saturating_mul(p.into()))
