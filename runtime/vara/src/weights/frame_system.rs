...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_250_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_593_000, 0)
            // Standard Error: 879
            .saturating_add(Weight::from_parts(690_365, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_697_000, 0)
            // Standard Error: 827
            .saturating_add(Weight::from_parts(524_995, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_463_000, 83)
            // Standard Error: 1_237
            .saturating_add(Weight::from_parts(1_110_046, 0).saturating_mul(p.into()))
