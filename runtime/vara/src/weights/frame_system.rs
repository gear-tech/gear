...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_415_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_640_000, 0)
            // Standard Error: 895
            .saturating_add(Weight::from_parts(674_064, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_673_000, 0)
            // Standard Error: 762
            .saturating_add(Weight::from_parts(529_835, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_489_000, 89)
            // Standard Error: 1_296
            .saturating_add(Weight::from_parts(1_113_810, 0).saturating_mul(p.into()))
