...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_253_000, 1485)
    ...
    fn set_code() -> Weight {
        ...
        //  Measured:  `0`
        //  Estimated: `1485`
        // Minimum execution time: 77_487_432_000 picoseconds.
        Weight::from_parts(81_523_893_000, 1485)
            .saturating_add(T::DbWeight::get().reads(1_u64))
            .saturating_add(T::DbWeight::get().writes(2_u64))
    }
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_595_000, 0)
            // Standard Error: 959
            .saturating_add(Weight::from_parts(689_315, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_593_000, 0)
            // Standard Error: 750
            .saturating_add(Weight::from_parts(517_405, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_292_000, 89)
            // Standard Error: 1_230
            .saturating_add(Weight::from_parts(1_080_032, 0).saturating_mul(p.into()))
