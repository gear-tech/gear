...
fn syscall_weights_test() {
    ...
    let expected = SyscallWeights {
        ...
        gr_reply_commit_wgas: 14_700_000.into(),
        gr_reservation_reply: 7_160_000.into(),
        gr_reservation_reply_per_byte: 715.into(),
        gr_reservation_reply_commit: 12_440_000.into(),
        gr_reply_push: 2_000_000.into(),
        gr_reply: 16_190_000.into(),
        gr_reply_per_byte: 750.into(),
        gr_reply_wgas: 16_440_000.into(),
        ...
        gr_leave: 11_980_000.into(),
        gr_wait: 10_730_000.into(),
        gr_wait_for: 14_380_000.into(),
        gr_wait_up_to: 11_480_000.into(),
        gr_wake: 3_300_000.into(),
        gr_create_program: 4_100_000.into(),
        gr_create_program_payload_per_byte: 140.into(),
        ...
        gr_create_program_wgas_salt_per_byte: 1_650.into(),
...
fn instantiation_costs_heuristic_test() {
    ...
    let expected_instantiation_costs = InstantiationCosts {
        ...
        table_section_per_byte: 721.into(),
