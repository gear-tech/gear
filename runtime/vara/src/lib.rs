...
construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic
    {
        ...
        BagsList: pallet_bags_list = 12,
        ImOnline: pallet_im_online = 13,
        Staking: pallet_staking = 14,
        Session: pallet_session = 7,
        Treasury: pallet_treasury = 15,
        Historical: pallet_session_historical = 16,
        ...
        StakingRewards: pallet_gear_staking_rewards = 48,

        // TODO: remove from production version
        Airdrop: pallet_airdrop = 49,
