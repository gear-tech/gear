...
use runtime_primitives::{Balance, BlockNumber, Hash, Header, Index, Moment};
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: create_runtime_str!("parachain-gear"),
...
parameter_types! {
    ...
    pub BlockGasLimit: u64 = GasLimitMaxPercentage::get() * RuntimeBlockWeights::get().max_block.ref_time();
