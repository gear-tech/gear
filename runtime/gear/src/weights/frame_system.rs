...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_331_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_571_000, 0)
            // Standard Error: 974
            .saturating_add(Weight::from_parts(687_544, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_570_000, 0)
            // Standard Error: 706
            .saturating_add(Weight::from_parts(527_682, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_256_000, 66)
            // Standard Error: 1_528
            .saturating_add(Weight::from_parts(1_112_001, 0).saturating_mul(p.into()))
