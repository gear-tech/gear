...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_096_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_547_000, 0)
            ...
            .saturating_add(Weight::from_parts(681_188, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_584_000, 0)
            // Standard Error: 779
            .saturating_add(Weight::from_parts(519_628, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_247_000, 65)
            // Standard Error: 1_289
            .saturating_add(Weight::from_parts(1_091_614, 0).saturating_mul(p.into()))
