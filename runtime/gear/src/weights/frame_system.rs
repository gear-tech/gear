...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn remark(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(1_482_260)
			// Standard Error: 0
    ...
    fn remark_with_event(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(7_355_000)
			// Standard Error: 0
			.saturating_add(Weight::from_ref_time(1_788).saturating_mul(b.into()))
    }
    fn set_heap_pages() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
		...
		Weight::from_parts(4_112_000, 495)
    ...
    fn set_storage(i: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 1_941 nanoseconds.
		Weight::from_ref_time(2_012_000)
			// Standard Error: 710
			.saturating_add(Weight::from_ref_time(721_068).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(1_952_000)
			// Standard Error: 904
			.saturating_add(Weight::from_ref_time(578_048).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
		...
		Weight::from_parts(3_630_000, 64)
			// Standard Error: 1_276
			.saturating_add(Weight::from_ref_time(1_247_039).saturating_mul(p.into()))
