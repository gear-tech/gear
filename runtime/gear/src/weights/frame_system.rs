...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn remark(b: u32, ) -> Weight {
        ...
        //  Measured:  `0`
        //  Estimated: `0`
        // Minimum execution time: 1_808 nanoseconds.
        Weight::from_ref_time(1_467_791)
            // Standard Error: 0
    ...
    fn remark_with_event(b: u32, ) -> Weight {
        ...
        Weight::from_ref_time(7_312_000)
            // Standard Error: 0
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(4_089_000, 495)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_ref_time(1_920_000)
            // Standard Error: 845
            .saturating_add(Weight::from_ref_time(730_345).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_ref_time(1_917_000)
            // Standard Error: 997
            .saturating_add(Weight::from_ref_time(582_846).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_551_000, 64)
            // Standard Error: 1_887
            .saturating_add(Weight::from_ref_time(1_297_401).saturating_mul(p.into()))
