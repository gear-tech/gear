...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_255_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_583_000, 0)
            // Standard Error: 825
            .saturating_add(Weight::from_parts(694_224, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_610_000, 0)
            // Standard Error: 778
            .saturating_add(Weight::from_parts(537_889, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_326_000, 73)
            // Standard Error: 1_451
            .saturating_add(Weight::from_parts(1_108_367, 0).saturating_mul(p.into()))
