...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_244_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_529_000, 0)
            // Standard Error: 994
            .saturating_add(Weight::from_parts(678_018, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_594_000, 0)
            // Standard Error: 771
            .saturating_add(Weight::from_parts(524_750, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_276_000, 66)
            // Standard Error: 1_318
            .saturating_add(Weight::from_parts(1_120_878, 0).saturating_mul(p.into()))
