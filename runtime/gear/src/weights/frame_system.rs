...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_364_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_578_000, 0)
            ...
            .saturating_add(Weight::from_parts(686_444, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_631_000, 0)
            // Standard Error: 709
            .saturating_add(Weight::from_parts(523_699, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_497_000, 66)
            // Standard Error: 1_411
            .saturating_add(Weight::from_parts(1_113_355, 0).saturating_mul(p.into()))
