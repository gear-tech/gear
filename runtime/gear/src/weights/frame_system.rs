...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_218_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_605_000, 0)
            ...
            .saturating_add(Weight::from_parts(703_583, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_556_000, 0)
            // Standard Error: 751
            .saturating_add(Weight::from_parts(532_261, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_367_000, 66)
            // Standard Error: 1_254
            .saturating_add(Weight::from_parts(1_105_532, 0).saturating_mul(p.into()))
