...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_712_000, 0)
            // Standard Error: 975
            .saturating_add(Weight::from_parts(692_285, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_656_000, 0)
            // Standard Error: 909
            .saturating_add(Weight::from_parts(522_279, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_350_000, 66)
            // Standard Error: 1_444
            .saturating_add(Weight::from_parts(1_102_650, 0).saturating_mul(p.into()))
