...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_238_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_622_000, 0)
            // Standard Error: 866
            .saturating_add(Weight::from_parts(686_292, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_607_000, 0)
            // Standard Error: 834
            .saturating_add(Weight::from_parts(530_667, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_444_000, 73)
            // Standard Error: 1_394
            .saturating_add(Weight::from_parts(1_140_548, 0).saturating_mul(p.into()))
