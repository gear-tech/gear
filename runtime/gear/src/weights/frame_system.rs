...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_158_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_606_000, 0)
            // Standard Error: 975
            .saturating_add(Weight::from_parts(679_287, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_548_000, 0)
            // Standard Error: 822
            .saturating_add(Weight::from_parts(532_754, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_189_000, 66)
            // Standard Error: 1_321
            .saturating_add(Weight::from_parts(1_123_880, 0).saturating_mul(p.into()))
