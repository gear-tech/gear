...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_080_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_608_000, 0)
            // Standard Error: 785
            .saturating_add(Weight::from_parts(683_070, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_578_000, 0)
            // Standard Error: 800
            .saturating_add(Weight::from_parts(530_000, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_438_000, 66)
            // Standard Error: 1_502
            .saturating_add(Weight::from_parts(1_118_143, 0).saturating_mul(p.into()))
