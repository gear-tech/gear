...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_417_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_802_000, 0)
            // Standard Error: 891
            .saturating_add(Weight::from_parts(687_558, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_742_000, 0)
            // Standard Error: 793
            .saturating_add(Weight::from_parts(525_505, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_486_000, 73)
            // Standard Error: 1_481
            .saturating_add(Weight::from_parts(1_131_430, 0).saturating_mul(p.into()))
