...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_206_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_548_000, 0)
            ...
            .saturating_add(Weight::from_parts(709_643, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_606_000, 0)
            // Standard Error: 919
            .saturating_add(Weight::from_parts(546_186, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_348_000, 70)
            // Standard Error: 1_499
            .saturating_add(Weight::from_parts(1_121_643, 0).saturating_mul(p.into()))
