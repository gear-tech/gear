...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_296_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_623_000, 0)
            // Standard Error: 964
            .saturating_add(Weight::from_parts(688_358, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_628_000, 0)
            // Standard Error: 764
            .saturating_add(Weight::from_parts(525_949, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_458_000, 73)
            // Standard Error: 1_226
            .saturating_add(Weight::from_parts(1_113_651, 0).saturating_mul(p.into()))
