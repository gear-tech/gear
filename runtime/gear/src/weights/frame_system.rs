...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_297_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_709_000, 0)
            // Standard Error: 915
            .saturating_add(Weight::from_parts(681_088, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_684_000, 0)
            // Standard Error: 864
            .saturating_add(Weight::from_parts(526_482, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_400_000, 73)
            // Standard Error: 1_305
            .saturating_add(Weight::from_parts(1_116_368, 0).saturating_mul(p.into()))
