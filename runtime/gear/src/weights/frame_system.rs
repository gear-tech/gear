...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_126_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_460_000, 0)
            // Standard Error: 882
            .saturating_add(Weight::from_parts(684_517, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_583_000, 0)
            // Standard Error: 821
            .saturating_add(Weight::from_parts(521_736, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_243_000, 66)
            // Standard Error: 1_572
            .saturating_add(Weight::from_parts(1_112_100, 0).saturating_mul(p.into()))
