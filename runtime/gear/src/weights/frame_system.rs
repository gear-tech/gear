...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn remark(b: u32, ) -> Weight {
        ...
        Weight::from_ref_time(1_286_395)
            // Standard Error: 0
    ...
    fn remark_with_event(b: u32, ) -> Weight {
        ...
        Weight::from_ref_time(7_224_000)
            // Standard Error: 0
            .saturating_add(Weight::from_ref_time(1_723).saturating_mul(b.into()))
    }
    fn set_heap_pages() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
        ...
        Weight::from_parts(4_142_000, 495)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_ref_time(1_844_000)
            // Standard Error: 752
            .saturating_add(Weight::from_ref_time(720_449).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_ref_time(1_915_000)
            // Standard Error: 941
            .saturating_add(Weight::from_ref_time(577_056).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        //  Measured:  `68 + p * (69 ±0)`
        //  Estimated: `64 + p * (70 ±0)`
        // Minimum execution time: 3_297 nanoseconds.
        Weight::from_parts(3_450_000, 64)
            // Standard Error: 1_579
            .saturating_add(Weight::from_ref_time(1_258_495).saturating_mul(p.into()))
