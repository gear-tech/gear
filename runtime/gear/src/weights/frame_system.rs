...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn remark(b: u32, ) -> Weight {
        Weight::from_ref_time(4_640_000 as u64)
            // Standard Error: 0
            .saturating_add(Weight::from_ref_time(341 as u64).saturating_mul(b as u64))
    }
    /// The range of component `b` is `[0, 1310720]`.
    fn remark_with_event(b: u32, ) -> Weight {
    ...
    fn set_storage(i: u32, ) -> Weight {
        Weight::from_ref_time(4_709_000 as u64)
            // Standard Error: 871
            .saturating_add(Weight::from_ref_time(851_705 as u64).saturating_mul(i as u64))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        Weight::from_ref_time(4_689_000 as u64)
            ...
            .saturating_add(Weight::from_ref_time(721_809 as u64).saturating_mul(i as u64))
            .saturating_add(T::DbWeight::get().writes((1 as u64).saturating_mul(i as u64)))
    }
    /// The range of component `p` is `[0, 1000]`.
    fn kill_prefix(p: u32, ) -> Weight {
        Weight::from_ref_time(6_553_000 as u64)
            // Standard Error: 1_372
            .saturating_add(Weight::from_ref_time(1_454_571 as u64).saturating_mul(p as u64))
