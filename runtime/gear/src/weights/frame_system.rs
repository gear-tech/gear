...
impl<T: frame_system::Config> frame_system::WeightInfo for SubstrateWeight<T> {
    ...
    fn set_heap_pages() -> Weight {
        ...
        Weight::from_parts(3_268_000, 1485)
    ...
    fn set_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_751_000, 0)
            // Standard Error: 965
            .saturating_add(Weight::from_parts(690_953, 0).saturating_mul(i.into()))
    ...
    fn kill_storage(i: u32, ) -> Weight {
        ...
        Weight::from_parts(1_676_000, 0)
            // Standard Error: 886
            .saturating_add(Weight::from_parts(524_369, 0).saturating_mul(i.into()))
            .saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
    }
    ...
    fn kill_prefix(p: u32, ) -> Weight {
        ...
        Weight::from_parts(3_523_000, 66)
            // Standard Error: 1_488
            .saturating_add(Weight::from_parts(1_108_252, 0).saturating_mul(p.into()))
