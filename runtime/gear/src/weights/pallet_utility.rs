...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(9_720_007, 0)
            // Standard Error: 3_035
            .saturating_add(Weight::from_parts(3_806_322, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(6_844_417, 0)
            // Standard Error: 3_777
            .saturating_add(Weight::from_parts(3_978_796, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(8_995_214, 0)
            // Standard Error: 2_042
            .saturating_add(Weight::from_parts(3_802_957, 0).saturating_mul(c.into()))
    }
}
