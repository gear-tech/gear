...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(4_423_143, 0)
            // Standard Error: 4_589
            .saturating_add(Weight::from_parts(3_947_978, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(10_424_905, 0)
            // Standard Error: 3_521
            .saturating_add(Weight::from_parts(4_132_846, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(12_202_657, 0)
            // Standard Error: 2_744
            .saturating_add(Weight::from_parts(3_910_883, 0).saturating_mul(c.into()))
    }
}
