...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(11_789_021, 0)
            // Standard Error: 4_504
            .saturating_add(Weight::from_parts(4_009_148, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(11_623_880, 0)
            // Standard Error: 7_083
            .saturating_add(Weight::from_parts(4_332_482, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(4_295_594, 0)
            // Standard Error: 4_960
            .saturating_add(Weight::from_parts(4_016_962, 0).saturating_mul(c.into()))
    }
}
