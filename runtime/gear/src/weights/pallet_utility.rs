...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(11_535_447, 0)
            // Standard Error: 2_309
            .saturating_add(Weight::from_parts(3_927_385, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(9_942_944, 0)
            // Standard Error: 2_001
            .saturating_add(Weight::from_parts(4_095_782, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(10_074_443, 0)
            // Standard Error: 1_757
            .saturating_add(Weight::from_parts(3_922_273, 0).saturating_mul(c.into()))
    }
}
