...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(12_032_650, 0)
            // Standard Error: 3_151
            .saturating_add(Weight::from_parts(3_922_844, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(8_004_734, 0)
            // Standard Error: 2_959
            .saturating_add(Weight::from_parts(4_122_777, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(14_441_824, 0)
            // Standard Error: 3_195
            .saturating_add(Weight::from_parts(3_921_899, 0).saturating_mul(c.into()))
    }
}
