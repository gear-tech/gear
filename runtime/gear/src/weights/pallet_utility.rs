...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_ref_time(8_714_859)
            // Standard Error: 1_623
            .saturating_add(Weight::from_ref_time(3_990_049).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
        //  Estimated: `0`
        // Minimum execution time: 4_454 nanoseconds.
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        //  Measured:  `0`
        //  Estimated: `0`
        // Minimum execution time: 5_995 nanoseconds.
        Weight::from_ref_time(13_443_648)
            // Standard Error: 1_642
            .saturating_add(Weight::from_ref_time(4_113_921).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
        ...
        Weight::from_ref_time(8_294_000)
    }
    /// The range of component `c` is `[0, 1000]`.
    fn force_batch(c: u32, ) -> Weight {
        // Proof Size summary in bytes:
        ...
        Weight::from_ref_time(14_802_796)
            // Standard Error: 1_511
            .saturating_add(Weight::from_ref_time(3_974_515).saturating_mul(c.into()))
    }
}
