...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(9_115_692, 0)
            // Standard Error: 3_072
            .saturating_add(Weight::from_parts(3_901_856, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(16_622_404, 0)
            // Standard Error: 3_047
            .saturating_add(Weight::from_parts(4_093_232, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(12_577_474, 0)
            // Standard Error: 2_235
            .saturating_add(Weight::from_parts(3_872_827, 0).saturating_mul(c.into()))
    }
}
