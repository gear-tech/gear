...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_ref_time(15_261_159)
            // Standard Error: 1_496
            .saturating_add(Weight::from_ref_time(4_008_492).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
        //  Estimated: `0`
        // Minimum execution time: 4_473 nanoseconds.
        Weight::from_ref_time(4_747_000)
    }
    /// The range of component `c` is `[0, 1000]`.
    fn batch_all(c: u32, ) -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
        //  Estimated: `0`
        // Minimum execution time: 6_044 nanoseconds.
        Weight::from_ref_time(16_929_902)
            // Standard Error: 2_225
            .saturating_add(Weight::from_ref_time(4_223_550).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
        ...
        Weight::from_ref_time(8_259_000)
    }
    /// The range of component `c` is `[0, 1000]`.
    fn force_batch(c: u32, ) -> Weight {
        // Proof Size summary in bytes:
        ...
        Weight::from_ref_time(13_876_400)
            // Standard Error: 1_570
            .saturating_add(Weight::from_ref_time(4_006_488).saturating_mul(c.into()))
    }
}
