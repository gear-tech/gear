...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        Weight::from_ref_time(22_696_000 as u64)
            // Standard Error: 1_708
            .saturating_add(Weight::from_ref_time(4_974_143 as u64).saturating_mul(c as u64))
    }
    fn as_derivative() -> Weight {
    ...
    /// The range of component `c` is `[0, 1000]`.
    fn batch_all(c: u32, ) -> Weight {
        Weight::from_ref_time(14_790_000 as u64)
            // Standard Error: 975
            .saturating_add(Weight::from_ref_time(5_120_158 as u64).saturating_mul(c as u64))
    }
    fn dispatch_as() -> Weight {
        Weight::from_ref_time(17_325_000 as u64)
    }
    /// The range of component `c` is `[0, 1000]`.
    fn force_batch(c: u32, ) -> Weight {
        Weight::from_ref_time(14_800_000 as u64)
            // Standard Error: 1_183
            .saturating_add(Weight::from_ref_time(4_972_081 as u64).saturating_mul(c as u64))
    }
}
