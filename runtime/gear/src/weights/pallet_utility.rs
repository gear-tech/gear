...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(11_136_352, 0)
            // Standard Error: 1_805
            .saturating_add(Weight::from_parts(3_756_766, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(9_411_870, 0)
            // Standard Error: 2_393
            .saturating_add(Weight::from_parts(3_972_899, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(6_723_613, 0)
            // Standard Error: 2_189
            .saturating_add(Weight::from_parts(3_779_633, 0).saturating_mul(c.into()))
    }
}
