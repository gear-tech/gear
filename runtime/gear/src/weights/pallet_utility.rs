...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(9_748_337, 0)
            // Standard Error: 3_690
            .saturating_add(Weight::from_parts(3_848_573, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(5_086_671, 0)
            // Standard Error: 4_095
            .saturating_add(Weight::from_parts(4_039_931, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(4_338_519, 0)
            // Standard Error: 3_006
            .saturating_add(Weight::from_parts(3_861_258, 0).saturating_mul(c.into()))
    }
}
