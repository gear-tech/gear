...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(6_446_718, 0)
            // Standard Error: 3_344
            .saturating_add(Weight::from_parts(3_962_744, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(10_290_615, 0)
            // Standard Error: 3_265
            .saturating_add(Weight::from_parts(4_100_121, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(4_006_273, 0)
            // Standard Error: 3_761
            .saturating_add(Weight::from_parts(3_977_276, 0).saturating_mul(c.into()))
    }
}
