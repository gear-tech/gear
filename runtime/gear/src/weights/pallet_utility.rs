...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(8_798_188, 0)
            // Standard Error: 2_360
            .saturating_add(Weight::from_parts(3_859_914, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(6_613_150, 0)
            // Standard Error: 2_902
            .saturating_add(Weight::from_parts(4_045_901, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(9_009_348, 0)
            // Standard Error: 2_400
            .saturating_add(Weight::from_parts(3_868_692, 0).saturating_mul(c.into()))
    }
}
