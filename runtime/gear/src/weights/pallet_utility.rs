...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(2_278_292, 0)
            // Standard Error: 3_369
            .saturating_add(Weight::from_parts(3_818_989, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(11_471_286, 0)
            // Standard Error: 3_248
            .saturating_add(Weight::from_parts(3_968_008, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(13_137_597, 0)
            // Standard Error: 2_882
            .saturating_add(Weight::from_parts(3_790_795, 0).saturating_mul(c.into()))
    }
}
