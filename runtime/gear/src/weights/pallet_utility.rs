...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(22_176_926, 0)
            // Standard Error: 3_078
            .saturating_add(Weight::from_parts(3_731_699, 0).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn batch_all(c: u32, ) -> Weight {
        ...
        Weight::from_parts(17_918_308, 0)
            // Standard Error: 2_904
            .saturating_add(Weight::from_parts(3_903_768, 0).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
        // Proof Size summary in bytes:
        //  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
        ...
        Weight::from_parts(20_345_637, 0)
            // Standard Error: 3_731
            .saturating_add(Weight::from_parts(3_735_664, 0).saturating_mul(c.into()))
    }
}
