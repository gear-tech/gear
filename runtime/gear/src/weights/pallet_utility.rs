...
impl<T: frame_system::Config> pallet_utility::WeightInfo for SubstrateWeight<T> {
    ...
    fn batch(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(8_782_128)
			// Standard Error: 1_583
			.saturating_add(Weight::from_ref_time(4_052_858).saturating_mul(c.into()))
    }
    fn as_derivative() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 4_654 nanoseconds.
    ...
    fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(11_554_786)
			// Standard Error: 1_802
			.saturating_add(Weight::from_ref_time(4_189_847).saturating_mul(c.into()))
    }
    fn dispatch_as() -> Weight {
		// Proof Size summary in bytes:
		//  Measured:  `0`
    ...
    fn force_batch(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(3_767_211)
			// Standard Error: 1_281
			.saturating_add(Weight::from_ref_time(4_115_149).saturating_mul(c.into()))
    }
}
