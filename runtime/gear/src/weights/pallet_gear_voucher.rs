...
// Executed Command:
// ./target/release/gear benchmark pallet --chain=gear-dev --steps=50 --repeat=20 --pallet=pallet_gear_voucher --extrinsic=issue --execution=wasm --wasm-execution=compiled --heap-pages=4096 --output=./scripts/benchmarking/weights-output/pallet_gear_voucher.rs --template=.maintain/frame-weight-template.hbs
...
impl<T: frame_system::Config> pallet_gear_voucher::WeightInfo for SubstrateWeight<T> {
    fn issue() -> Weight {
        ...
        //  Measured:  `101`
        //  Estimated: `6196`
        // Minimum execution time: 80_622_000 picoseconds.
        Weight::from_parts(86_158_000, 6196)
