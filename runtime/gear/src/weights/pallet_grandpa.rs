...
// Executed Command:
// ./target/release/gear benchmark pallet --chain=gear-dev --steps=50 --repeat=20 --pallet=pallet_grandpa --extrinsic=* --execution=wasm --wasm-execution=compiled --heap-pages=4096 --output=./scripts/benchmarking/weights-output/pallet_grandpa.rs --template=.maintain/frame-weight-template.hbs
...
impl<T: frame_system::Config> pallet_grandpa::WeightInfo for SubstrateWeight<T> {
    ...
    fn check_equivocation_proof(_x: u32, ) -> Weight {
        Weight::from_ref_time(173_004_518 as u64)
    }
    fn note_stalled() -> Weight {
        Weight::from_ref_time(10_159_000 as u64)
