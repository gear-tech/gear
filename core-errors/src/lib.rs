...
pub enum ExecutionError {
    ...
    /// The error occurs when invalid cost identifier given.
    #[display(fmt = "Invalid cost identifier")]
    InvalidCostIdentifier = 109,
}
...
impl ExtError {
    ...
    pub fn from_u32(code: u32) -> Option<Self> {
        match code {
            ...
            109 => Some(ExecutionError::InvalidCostIdentifier.into()),
            //
