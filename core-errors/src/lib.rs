...
pub enum MessageError {
    ///  The error "Message limit exceeded" occurs when a program attempts to send more than the maximum amount of messages alowed within a single execution (1024).
